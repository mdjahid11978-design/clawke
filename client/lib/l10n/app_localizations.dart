...
abstract class AppLocalizations {
  ...
  ///
  /// In zh, this message translates to:
  /// **'扫描 skills/ 目录中的 SKILL.md，支持创建、编辑、禁用和删除托管技能。'**
  String get skillsPageSubtitle;

  /// No description provided for @skillsMetricAll.
  ///
  /// In zh, this message translates to:
  /// **'全部'**
  String get skillsMetricAll;

  /// No description provided for @skillsMetricEnabled.
  ///
  /// In zh, this message translates to:
  /// **'启用'**
  String get skillsMetricEnabled;
  ...
  /// No description provided for @skillsStatusAll.
  ///
  /// In zh, this message translates to:
  /// **'全部'**
  String get skillsStatusAll;

  /// No description provided for @skillsStatusEnabled.
  ///
  /// In zh, this message translates to:
  /// **'已启用'**
  String get skillsStatusEnabled;

  /// No description provided for @skillsStatusDisabled.
  ///
  /// In zh, this message translates to:
  /// **'已禁用'**
  String get skillsStatusDisabled;

  /// No description provided for @skillsSourceAll.
  ///
  /// In zh, this message translates to:
  /// **'全部来源'**
  String get skillsSourceAll;

  /// No description provided for @skillsSourceManaged.
  ///
  /// In zh, this message translates to:
  /// **'托管'**
  String get skillsSourceManaged;

  /// No description provided for @skillsSourceExternal.
  ///
  /// In zh, this message translates to:
  /// **'外部'**
  String get skillsSourceExternal;

  /// No description provided for @skillsSourceReadonly.
  ///
  /// In zh, this message translates to:
  /// **'只读'**
  String get skillsSourceReadonly;

  /// No description provided for @skillsConflict.
  ///
  /// In zh, this message translates to:
  /// **'冲突'**
  String get skillsConflict;

  /// No description provided for @skillsTriggerLabel.
  ///
  /// In zh, this message translates to:
  /// **'触发：{trigger}'**
  ...
  /// No description provided for @skillsDeleted.
  ///
  /// In zh, this message translates to:
  /// **'技能已删除'**
  String get skillsDeleted;
  ...
  ///
  /// In zh, this message translates to:
  /// **'将删除 {name} 的 SKILL.md 和所在技能目录，此操作不可撤销。'**
  ...
  /// No description provided for @skillsFieldName.
  ///
  /// In zh, this message translates to:
  /// **'名称'**
  String get skillsFieldName;

  /// No description provided for @skillsFieldCategory.
  ///
  /// In zh, this message translates to:
  /// **'分类'**
  String get skillsFieldCategory;

  /// No description provided for @skillsFieldTrigger.
  ///
  /// In zh, this message translates to:
  /// **'触发说明'**
  String get skillsFieldTrigger;

  /// No description provided for @skillsFieldDescription.
  ///
  /// In zh, this message translates to:
  /// **'描述'**
  String get skillsFieldDescription;

  /// No description provided for @skillsDescriptionRequired.
  ///
  /// In zh, this message translates to:
  /// **'请输入描述'**
  String get skillsDescriptionRequired;

  /// No description provided for @skillsSkillMdBody.
  ///
  /// In zh, this message translates to:
  /// **'SKILL.md 正文'**
  String get skillsSkillMdBody;

  /// No description provided for @skillsFieldRequired.
  ///
  /// In zh, this message translates to:
  /// **'必填'**
  String get skillsFieldRequired;

  /// No description provided for @skillsPathPartInvalid.
  ///
  /// In zh, this message translates to:
  /// **'只能使用字母、数字、点、下划线和横线'**
  ...
  /// No description provided for @skillModePriority.
  ///
  /// In zh, this message translates to:
  /// **'优先使用这些 Skills'**
  String get skillModePriority;
  ...
  /// No description provided for @cardGeneratingOptions.
  ///
  /// In zh, this message translates to:
  /// **'正在生成选项...'**
  String get cardGeneratingOptions;

  /// No description provided for @cardGeneratingApproval.
  ///
  /// In zh, this message translates to:
  /// **'正在生成审批请求...'**
  String get cardGeneratingApproval;

  /// No description provided for @cardNeedConfirm.
  ///
  /// In zh, this message translates to:
  /// **'需要确认'**
  String get cardNeedConfirm;

  /// No description provided for @cardApprove.
  ///
  /// In zh, this message translates to:
  /// **'允许'**
  String get cardApprove;

  /// No description provided for @cardDeny.
  ///
  /// In zh, this message translates to:
  /// **'拒绝'**
  String get cardDeny;

  /// No description provided for @cardApproved.
  ///
  /// In zh, this message translates to:
  /// **'已允许'**
  String get cardApproved;

  /// No description provided for @cardDenied.
  ///
  /// In zh, this message translates to:
  /// **'已拒绝'**
  String get cardDenied;
  ...
  /// No description provided for @cardApprovedPersist.
  ///
  /// In zh, this message translates to:
  /// **'✅ 已允许: {command}'**
  String cardApprovedPersist(String command);

  /// No description provided for @cardDeniedPersist.
  ///
  /// In zh, this message translates to:
  /// **'🚫 已拒绝: {command}'**
  String cardDeniedPersist(String command);

  /// No description provided for @cardSelectedPersist.
  ///
  /// In zh, this message translates to:
  /// **'✅ 已选择: {choice}'**
  String cardSelectedPersist(String choice);

  /// No description provided for @cardRiskHigh.
  ///
  /// In zh, this message translates to:
  /// **'高风险'**
  String get cardRiskHigh;

  /// No description provided for @cardRiskMedium.
  ///
  /// In zh, this message translates to:
  /// **'中风险'**
  String get cardRiskMedium;

  /// No description provided for @cardRiskLow.
  ///
  /// In zh, this message translates to:
  /// **'低风险'**
  String get cardRiskLow;

  /// No description provided for @cardOtherOptionHint.
  ///
  /// In zh, this message translates to:
  /// **'其他选项可直接在下方输入框回复'**
  String get cardOtherOptionHint;

  /// No description provided for @cardCopyCode.
  ///
  /// In zh, this message translates to:
  /// **'复制代码'**
  String get cardCopyCode;

  /// No description provided for @cardCodeCopied.
  ///
  /// In zh, this message translates to:
  /// **'已复制'**
  String get cardCodeCopied;
  ...
  /// No description provided for @errorNoReply.
  ///
  /// In zh, this message translates to:
  /// **'AI 未能生成回复，请重试或开始新会话'**
  String get errorNoReply;

  /// No description provided for @errorAgentError.
  ///
  /// In zh, this message translates to:
  /// **'AI 处理出错：{detail}'**

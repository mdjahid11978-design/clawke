...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get skillsMetricAll => '全部';

  @override
  String get skillsMetricEnabled => '启用';
  ...
  @override
  String get skillsStatusAll => '全部';

  @override
  String get skillsStatusEnabled => '已启用';

  @override
  String get skillsStatusDisabled => '已禁用';

  @override
  String get skillsSourceAll => '全部来源';

  @override
  String get skillsSourceManaged => '托管';

  @override
  String get skillsSourceExternal => '外部';

  @override
  String get skillsSourceReadonly => '只读';

  @override
  String get skillsConflict => '冲突';
  ...
  @override
  String get skillsDeleted => '技能已删除';
  ...
  String skillsDeleteMessage(String name) {
    return '将删除 $name 的 SKILL.md 和所在技能目录，此操作不可撤销。';
  }
  ...
  @override
  String get skillsFieldName => '名称';

  @override
  String get skillsFieldCategory => '分类';

  @override
  String get skillsFieldTrigger => '触发说明';

  @override
  String get skillsFieldDescription => '描述';

  @override
  String get skillsDescriptionRequired => '请输入描述';

  @override
  String get skillsSkillMdBody => 'SKILL.md 正文';

  @override
  String get skillsFieldRequired => '必填';

  @override
  String get skillsPathPartInvalid => '只能使用字母、数字、点、下划线和横线';
  ...
  @override
  String get logoutConfirmTitle => '确认退出登录';

  @override
  String get logoutConfirmContent => '退出登录后需要重新登录才能使用 Relay 服务。';
  ...
  @override
  String get currentAccount => '当前';

  @override
  String get accountExpired => '该账号登录已过期，请重新登录';

  @override
  String get switchAccountHint => '点击账号即可切换';
  ...
  @override
  String get noSkillsAvailable => '暂无已安装的 Skills';
  ...
  @override
  String get cardGeneratingOptions => '正在生成选项...';

  @override
  String get cardGeneratingApproval => '正在生成审批请求...';

  @override
  String get cardNeedConfirm => '需要确认';

  @override
  String get cardApprove => '允许';

  @override
  String get cardDeny => '拒绝';

  @override
  String get cardApproved => '已允许';

  @override
  String get cardDenied => '已拒绝';
  ...
  @override
  String get cardRiskHigh => '高风险';

  @override
  String get cardRiskMedium => '中风险';

  @override
  String get cardRiskLow => '低风险';

  @override
  String get cardOtherOptionHint => '其他选项可直接在下方输入框回复';

  @override
  String get cardCopyCode => '复制代码';

  @override
  String get cardCodeCopied => '已复制';

  @override
  String get errorAuthFailed => 'AI 服务认证失败，请检查 API Key 配置';

  @override
  String get errorNetworkError => 'AI 服务连接超时，请检查网络';

  @override
  String get errorRateLimited => '请求过于频繁，请稍后重试';

  @override
  String get errorModelUnavailable => '所选 AI 模型不可用，请检查模型配置';

  @override
  String get errorNoReply => 'AI 未能生成回复，请重试或开始新会话';

  @override
  String errorAgentError(String detail) {
    return 'AI 处理出错：$detail';
  }
}

...
> 2026-04-26 更新：本计划中的 “Stable UI Keys / `ui_e2e_*` key” 方案已废弃。后续 UI E2E 必须遵循 `test/ui-e2e/docs/locator-strategy.md`：用户语义优先，少量 `Semantics.identifier` 兜底，不新增系统级 `ui_e2e_*` key。
